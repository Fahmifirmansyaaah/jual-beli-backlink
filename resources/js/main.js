...
document.addEventListener("DOMContentLoaded", function () {
    // Cari semua elemen swiper yang pakai JSON config
    document.querySelectorAll(".swiper.init-swiper").forEach((swiperEl) => {
        ...
        if (configEl) {
            try {
                ...
                console.error("Failed to parse Swiper config JSON", error);
            }
        }
